package com.bitcode.recyclerview5.adapters
...
import com.bitcode.recyclerview5.R
...
class ProductsAdapter(
    ...
    class ProductViewHolder(view : View) : RecyclerView.ViewHolder(view) {
        ...
        var txtProcutPrice : TextView

        init {
            imgProduct = view.findViewById(R.id.imgProduct)
            txtProductTitle = view.findViewById(R.id.txtProductTitle)
            txtProcutPrice = view.findViewById(R.id.txtProductPrice)
        }
    }
    ...
    class AdvertisementViewHolder(view : View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            ...
            txtAdvertisementTitle = view.findViewById(R.id.txtAdvertisementTile)
        }
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if(holder is ProductViewHolder) {
            ...
            holder.txtProcutPrice.text = "Rs. ${product.price}"
